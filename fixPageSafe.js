...
// 3. Remove old Pemasta banner
const bannerStart = content.indexOf('{isPetani && latestPrice && (');
const bannerEnd = content.indexOf(')}', bannerStart) + 2;
// Check if it's the right one (contains 'Pemberitahuan Pemasta Node')
if (content.substring(bannerStart, bannerEnd).includes('Pemberitahuan Pemasta Node')) {
