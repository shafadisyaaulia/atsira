...
const T_HOME = {
  ...
  rootsQuote: {
    ID: "“Ia (nilam) adalah warisan budaya dan identitas ekonomi kita. Untuk menjadikannya unggul di pasar global, kita membutuhkan sinergi antar bidang ilmu, teknologi tepat guna, dan kebijakan pembangunan yang berpihak pada produk lokal.”",
    EN: "“It (patchouli) is our cultural heritage and economic identity. To make it competitive in the global market, we need synergy between scientific fields, appropriate technology, and development policies that favor local products.”"
  },
  rootsQuoteAuthor: {
    ID: "— Dr. Syaifullah Muhammad pada pembukaan IConPEORI.",
    EN: "— Dr. Syaifullah Muhammad at the opening of IConPEORI."
  },
