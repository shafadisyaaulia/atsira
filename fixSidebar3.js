...
const regex = /<div className="border-t border-stone-100 pt-4 space-y-3">[\s\S]*?Kelompok Suling Jaya<\/p>\s*<p className="text-\[10px\] text-stone-400">Petani Mitra ARC<\/p>\s*<\/div>\s*<\/div>\s*<\/div>/;
